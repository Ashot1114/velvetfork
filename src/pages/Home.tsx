  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -right-8 w-[130px] h-[130px] bg-primary rounded-full flex flex-col items-center justify-center text-primary-foreground text-center">
              ...
              <span className="text-[0.62rem] tracking-[0.12em] uppercase font-medium">{t("home.yearsExcellence")}</span>
            </div>
          </div>
          <div>
            <p className="font-sans text-[0.72rem] tracking-[0.25em] uppercase text-primary mb-4">{t("home.philosophy")}</p>
            <h2 className="font-serif text-[clamp(2.2rem,5vw,3.8rem)] font-light leading-[1.15] text-foreground mb-6">
              {t("home.soulTitle")} <em className="italic text-primary">{t("home.soul")}</em>
            </h2>
            <p className="text-muted-foreground text-[0.95rem] leading-relaxed mb-5">{t("home.intro1")}</p>
            <p className="text-muted-foreground text-[0.95rem] leading-relaxed mb-5">{t("home.intro2")}</p>
      ...
      <section className="py-24 px-[5%] bg-secondary transition-colors">
        <SectionHeader label={t("home.chefsSelections")} title={t("home.featured")} titleAccent={t("home.dishes")} />
      ...
      <section className="py-32 px-[5%] text-center">
        <SectionHeader label={t("home.guestReviews")} title={t("home.whatGuests")} titleAccent={t("home.say")} />
